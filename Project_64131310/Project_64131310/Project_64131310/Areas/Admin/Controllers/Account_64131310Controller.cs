...
namespace Project_64131310.Areas.Admin.Controllers
{
    ...
    public class Account_64131310Controller : Controller
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;
        private ApplicationDbContext db = new ApplicationDbContext();
        public Account_64131310Controller()
        {
        }

        public Account_64131310Controller(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
       ...
       [ValidateAntiForgeryToken]
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Index", "Home_64131310");
        }
        //
        ...
        public async Task<ActionResult> Create(CreateAccountViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index", "Account_64131310");
                }
                AddErrors(result);
            }
            ViewBag.Role = new SelectList(db.Roles.ToList(), "Name", "Name");
